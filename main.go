...
const (
	...
	POST_INDEX  = "post"
	POST_TYPE   = "post"
	PROJECT_ID  = "goaround-236002"
	BT_INSTANCE = "goaround-post"

	//
	ES_URL      = "http://35.236.108.116:9200"
	BUCKET_NAME = "yzz-goaround-project"
)
...
func main() {
	...
	http.HandleFunc("/cluster", handlerCluster) // TODO
...
func handlerCluster(w http.ResponseWriter, r *http.Request) {
	...
	query := elastic.NewRangeQuery(term).Gte(0.95)
